...
*   CodeRAG saves its configuration in a global cache folder (`~/.cache/code-rag/config.json`). This file is readable by your user. Ensure your system is secure if you store sensitive keys there.
